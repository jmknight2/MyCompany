        ...
        data: data
            ...
            <div class="col-md-4" style="padding: 10px;">
                <div style="width: 100%; padding: 10px; background-color: #23b3e0; box-shadow: 5px 5px 5px #0f5f8a; border-radius: 5px;">
                    <h2 style="margin: 0; margin-bottom: 20px; text-align:center; color: white; font-weight: bold">Your Sales</h2>
                    <table class="table">
                        <?php
                            $userRow = $db->query("select sales from Users where user_id = $user_id")->fetch_array();
                            $usersSales = $userRow[0];
                            echo "
                            <tr>
                                <td><h3 style='text-align: center'>$$usersSales</h3></td>
                            </tr>
                            ";
                        ?>
                    </table>
