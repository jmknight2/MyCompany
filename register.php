...
<html lang="en">
    ...
    <body style="background-color: #b7e9f7;">
        ...
        <div class="container-fluid">
            ...
            <div class="col-8-sm col-centered" style="max-width: 400px; background-color: #23b3e0; padding: 15px; border-radius: 5px; box-shadow: 5px 5px 15px #1a1a1a;">
              <h2 style="margin-top: 0px; font-weight: bold; color: white">Create New Account</h2>
              <form action="register_script.php" method="post">
                <div class="form-group" style="text-align: left; margin: 0 auto;">
                    ...
                    <input style="max-width: 400px" type="text" class="form-control" id="fName" placeholder="Enter first name" name="fName" required>
                </div>
                <div class="form-group" style="text-align: left; margin: 0 auto;">
                    <label for="lName"><h3>Last Name</h3></label>
                    <input style="max-width: 400px" type="text" class="form-control" id="lName" placeholder="Enter last name" name="lName" required>
                </div>
                <div class="form-group" style="text-align: left; margin: 0 auto;">
                ...
                <div class="form-group" style="text-align: left">
                    ...
                    <input style="max-width: 400px" type="password" class="form-control" id="pwd" placeholder="Enter password" name="pwd" minlength="6" required>
                </div>
                <div class="form-group" style="text-align: left">
                    <label for="rePwd"><h3>Re-Type Password</h3></label>
                    <input style="max-width: 400px" type="password" class="form-control" id="rePwd" placeholder="Enter password again" name="rePwd" required>
                </div>
                <button type="submit" class="btn btn-primary btn-lg" style="margin: 0 auto; width: 75%">Create Account</button>
              </form>
            </div>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo $_SESSION['modalMessage'];?>
                    </div>
